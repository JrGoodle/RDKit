...
build_xcframework() {
    ...
    xcodebuild -create-xcframework \
        -library "${INSTALL_DIR}/macosx-arm64/lib/libRDKit${library_name}_static.a" \
        -library "${INSTALL_DIR}/ios-arm64/lib/libRDKit${library_name}_static.a" \
        -library "${INSTALL_DIR}/iossim-arm64/lib/libRDKit${library_name}_static.a" \
        -library "${INSTALL_DIR}/xros-arm64/lib/libRDKit${library_name}_static.a" \
        -library "${INSTALL_DIR}/xrossim-arm64/lib/libRDKit${library_name}_static.a" \
...
cp -R "${INSTALL_DIR}/ios-arm64/include" "${FRAMEWORKS_DIR}/Headers"
